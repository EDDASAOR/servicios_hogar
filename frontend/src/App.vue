<template>
  <div style="min-height:100vh; display:flex; flex-direction:column; background:#f8fafc;">
    ...
    <!-- Main Content -->
    <main style="flex:1; padding-top:68px;">
    ...
    <!-- WhatsApp FAB -->
    <a v-if="!isAuthPage" href="https://wa.me/1234567890" target="_blank" class="hp-whatsapp" title="Chatea con nosotros">
      <div class="hp-whatsapp__ring"></div>
...
.hp-whatsapp:hover { transform: scale(1.12); }
.hp-whatsapp__ring {
  position: absolute;
  inset: 0;
  border-radius: 50%;
